...
abstract: |-
  We study the rise of private credit (PC) lending and its competition with syndicated bank lending. We document four stylized facts—(i) PC expansion following negative shocks to bank credit supply, (ii) differences in product composition, (iii) segmentation by borrower type, and (iv) the reliance of PC funds on bank financing—to argue that PC and bank loans are *imperfect substitutes*.
